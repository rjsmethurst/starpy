...
model = str(raw_input('Tell me again the location of the SPS model to use to predict the u-r and NUV-u colours, e.g. ~/extracted_bc2003_lr_m62_chab_ssp.ised_ASCII :'))
data = N.loadtxt(dir)
model_ages = data[0,1:]
